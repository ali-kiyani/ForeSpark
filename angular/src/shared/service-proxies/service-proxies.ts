...
export class ProductServiceProxy {
    ...
    protected processCreateNewProduct(response: HttpResponseBase): Observable<ProductDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getProductDetails(id: number | undefined): Observable<ProductDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/Product/getProductDetails?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProductDetails(<any>response_);
                } catch (e) {
    ...
    protected processGetProductDetails(response: HttpResponseBase): Observable<ProductDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    addProductImagesForProduct(productId: number | undefined, body: string[] | null | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Product/AddProductImagesForProduct?";
        if (productId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddProductImagesForProduct(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddProductImagesForProduct(<any>response_);
                } catch (e) {
    ...
    protected processAddProductImagesForProduct(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ProductDtoPagedResultDto> {
...
export class WarehouseServiceProxy {
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<WarehouseDtoPagedResultDto> {
...
@Injectable()
export class WarehouseProductsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<WarehouseProductsDto> {
        let url_ = this.baseUrl + "/api/services/app/WarehouseProducts/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<WarehouseProductsDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<WarehouseProductsDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<WarehouseProductsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = WarehouseProductsDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<WarehouseProductsDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<WarehouseProductsDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/WarehouseProducts/GetAll?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<WarehouseProductsDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<WarehouseProductsDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<WarehouseProductsDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = WarehouseProductsDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<WarehouseProductsDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: CreateWarehouseProductsDto | undefined): Observable<WarehouseProductsDto> {
        let url_ = this.baseUrl + "/api/services/app/WarehouseProducts/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<WarehouseProductsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: WarehouseProductsDto | undefined): Observable<WarehouseProductsDto> {
        let url_ = this.baseUrl + "/api/services/app/WarehouseProducts/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<WarehouseProductsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/WarehouseProducts/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class WarehouseProductsDto implements IWarehouseProductsDto {
    warehouseId: number;
    productId: number;
    totalStock: number;
    soldStock: number;
    ...
    constructor(data?: IWarehouseProductsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.soldStock = _data["soldStock"];
            this.warehouse = _data["warehouse"] ? WarehouseDto.fromJS(_data["warehouse"]) : <any>undefined;
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): WarehouseProductsDto {
        data = typeof data === 'object' ? data : {};
        let result = new WarehouseProductsDto();
        result.init(data);
        return result;
    }
...
export interface IWarehouseProductsDto {
    warehouseId: number;
    productId: number;
    totalStock: number;
    soldStock: number;
...
export class CreateProductDto implements ICreateProductDto {
    ...
    weight: number | undefined;
    description: string | undefined;
    warehouseProducts: WarehouseProductsDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.weight = _data["weight"];
            this.description = _data["description"];
            if (Array.isArray(_data["warehouseProducts"])) {
                this.warehouseProducts = [] as any;
                for (let item of _data["warehouseProducts"])
                    this.warehouseProducts.push(WarehouseProductsDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["weight"] = this.weight;
        data["description"] = this.description;
        if (Array.isArray(this.warehouseProducts)) {
            data["warehouseProducts"] = [];
            for (let item of this.warehouseProducts)
                data["warehouseProducts"].push(item.toJSON());
        }
        return data; 
    }
...
export class ProductDetailsDto implements IProductDetailsDto {
    productId: number;
    warehouseProductsDetails: WarehouseProductsDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            this.productId = _data["productId"];
            if (Array.isArray(_data["warehouseProductsDetails"])) {
                this.warehouseProductsDetails = [] as any;
                for (let item of _data["warehouseProductsDetails"])
                    this.warehouseProductsDetails.push(WarehouseProductsDto.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["productId"] = this.productId;
        if (Array.isArray(this.warehouseProductsDetails)) {
            data["warehouseProductsDetails"] = [];
            for (let item of this.warehouseProductsDetails)
                data["warehouseProductsDetails"].push(item.toJSON());
        }
...
export class WarehouseProductsDtoPagedResultDto implements IWarehouseProductsDtoPagedResultDto {
    totalCount: number;
    items: WarehouseProductsDto[] | undefined;

    constructor(data?: IWarehouseProductsDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(WarehouseProductsDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): WarehouseProductsDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new WarehouseProductsDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): WarehouseProductsDtoPagedResultDto {
        const json = this.toJSON();
        let result = new WarehouseProductsDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IWarehouseProductsDtoPagedResultDto {
    totalCount: number;
    items: WarehouseProductsDto[] | undefined;
}

export class CreateWarehouseProductsDto implements ICreateWarehouseProductsDto {
    warehouseId: number;
    productId: number;
    totalStock: number;
    soldStock: number;

    constructor(data?: ICreateWarehouseProductsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateWarehouseProductsDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateWarehouseProductsDto();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateWarehouseProductsDto {
        const json = this.toJSON();
        let result = new CreateWarehouseProductsDto();
        result.init(json);
        return result;
...
export interface ICreateWarehouseProductsDto {
    warehouseId: number;
    productId: number;
    totalStock: number;
    soldStock: number;
